...
<a class="openvideo" href="#" onclick="openVideo('<?php echo $info['id'] ?>')"><img width=200 height=100 src="https://img.youtube.com/vi/<?php echo $video_id ?>/mqdefault.jpg" border="0"></a>
