    ...
    <div class="controls">
        ...
        <div class="announce"><i class="fa fa-tag"></i> ANNOUNCEMENTS</div>
          ...
          <div id="desc" class="desc">
              ...
              <p style="margin-top:8px; font-style: italic;"><small>This project is brand new and hardly crawling, so we appreciate your patience and feedback when you encounter any errors. Thanks!</small><br><br>
