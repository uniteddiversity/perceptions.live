  ...
  <div class="card-body">
    <div class="table-responsive">
      <div class="form-header">
        ...
        <p class="page-desc">
          In order to effectively network the communities of the world, the {{env('APP_NAME')}} platform automatically creates 'shadow profiles' of users and groups who are featured in media yet not yet registered in the system.<br>
      ...
      <form action="/claim-profile-post" method="post" enctype='multipart/form-data'>
        ...
        <div class="form-group">
          ...
          <label for="password" style="float: none"> I have read and understand {{env('APP_NAME')}} <a target="_blank" href="https://perceptiontravel.tv/terms-of-service/">Terms of Service</a>.</label>
        </div>
