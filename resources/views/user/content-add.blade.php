...
<div class="col-lg-12 grid-margin stretch-card" id="user_content_add">
      ...
      <div class="submitprcption row">
        <div class="col-lg-4">
          <div class="box purple" style="padding-top:40px;">
            ...
            <p style="margin:0;">Use this page to submit your own content that supports the exposure of cooperative, smiling people endeavors worldwide. We'll review it, get back to you if necessary, and it will become a part of the network!
            </p>
            <span class="mobile_show">Read More
            </span>
        ...
        <div class="content-add-form col-lg-8">
          <div class="breadcrumbs">
            <div class="line">
            </div>
            <ul class="step-icons-wrapper">
          ...
          <div class="pagedesc">
            <div class="table-responsive">
              ...
              <form action="/user/post-upload-video" method="post" id="submit_content" enctype='multipart/form-data'>
                ...
                <div class="step" id="st1">
                  ...
                  <div class="text_top">
                    ...
                    <p>In this section, please fill in the basic details about your PRCPTION submission.
                    </p>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Title of this PRCPTION
                    </label>
                    <input type="text" class="form-control" aria-describedby="nameHelp" name="title" placeholder="Title" value="{{ old('title',$data['title']) }}">
                  </div>
                  <div class="form-group">
                    <label for="exampleTextarea">Location (City, Country)
                    </label>
                  ...
                  <div class="form-group">
                    <label for="video_id">Date of PRCPTION
                    </label>
                  ...
                  <div class="btn_outer">
                    ...
                    <a href="#" class="btn click" rel="st2">Next Step 
                ...
                <div class="step hidden" id="st2">
                  ...
                  <div class="text_top">
                    ...
                    <p>Before we begin: is this media online already? Or do you need to be connected with an editor?
                    </p>
                  </div>
                  <!-- top text -->
                  <div class="form-group">
                    <div class="custom_select">
                      <select class="form-control" id="submitted_footage" name="submitted_footage" onchange="displayVideoContentUpload()" placeholder="How is your video?">
                        <option value="no" 
                                <?php if(old('submitted_footage',$data['submitted_footage'])=='no' ){ echo 'selected' ; } ?> >My video is completed.
                        </option>
                      <option id="2" value="yes" 
                              <?php if(old('submitted_footage',$data['submitted_footage'])=='yes' ){ echo 'selected' ; } ?> >I need to submit my footage!
                      </option>
                    </select>
                </div>
                </div>
              <div class="form-group" id="submit_footage_form" 
                   <?php if(old('submitted_footage',$data['submitted_footage'])=='yes' ){ echo 'style="display:true"' ; }else{ echo 'style="display:none"' ; } ?> >
              <div class="tinfo">
                <p style="margin:0; color:rgb(81, 81, 81);">
                  <b style="color:#4214c7;">Cool! PRCPTION Travel will be excited to work with you! :)
                  </b>
                  <br />
                  <br />
                  Before you begin, please 
                  <a href="https://perceptiontravel.tv/share/" target="_blank">familiarize yourself with the steps required
                  </a> for your video to be edited. The process is designed to split the responsibility of sharing inspiring and community-building stories around the world; please play your part by organizing your footage appropriately before submission.
                </p>
              </div>
              <label for="submit_footage_form">Upload Your Content (max 200MB each)
              </label>
              ...
              <a class="question" href="#" data-toggle="modal" data-target="#step2"> 
                <i class="fas fa-question">
                </i>
              </a>
              <div class="drag">
              ...
              <a class="question" href="#" data-toggle="modal" data-target="#step3"> 
                <i class="fas fa-question">
                </i>
              </a>
              <div class="drag">
            ...
            <div class="form-group url">
              <label for="exampleTextarea">If it's already completed, what is the video's URL? (YouTube, Vimeo, etc)
              </label>
              <input type="text" class="form-control" aria-describedby="nameHelp" name="url" placeholder="URL" value="{{ old('url',$data['url']) }}">
            </div>
            <div class="form-group">
              <label for="exampleTextarea">Comments, notes, or concerns about this PRCPTION that we (or the video editor) should know?
              </label>
              <textarea type="text" class="form-control" aria-describedby="nameHelp" name="user_comment" placeholder="Additional Comments" rows="4">{{ old('user_comment',$data['user_comment']) }}
              </textarea>
            </div>
            <div class="form-group" style="padding:0 40px;">
              ...
              <select class="form-control" id="status" name="status">
                ...
                <option value="{{$st->id}}" 
                        <?php if(old('status',$data['status'])==$st->id){ echo 'selected'; } ?> >{{$st->name}}
                </option>
              @endforeach
              </select>
            <?php } ?>
          ...
          <!-- btns -->
          <div class="btn_outer">
            <a href="#" class="btn click" rel="st1">
              <i class="fas fa-long-arrow-alt-left">
              </i> Back
            </a>
            <a href="#" class="btn click" rel="st3" style="float:right;">Next Step 
              <i class="fas fa-long-arrow-alt-right">
              </i>
            </a>
            <!-- submit button //hidden for DEMO ONLY -->
            <button type="button" onclick="submit_content()" class="btn dark" rel="st4" style="display:none;">Submit PRCPTION
            </button>
          </div>
          <!-- btns -->
        </div>
        ...
        <div class="step hidden" id="st3">
          ...
          <div class="text_top">
            ...
            <p>In this section, please choose the individuals and groups who have been a part of this PRCPTION. If no name appears, press 'enter' to add them as a shadow profile--don't worry, you can let them know and they can 
              <a href="/claim-profile">claim their empty profile
              </a> whenever they want.
            </p>
          </div>
          <div class="form-group">
            <label for="video_producer">Video Producer(s) (you may tag yourself)
            </label>
            {{--
            ...
            <select class="form-control multi-select2-with-tags" id="video_producer" multiple searchable="Search here.." name="video_producer[]">
              ...
              <option value="{{base64_encode($user->id)}}" 
                      <?php if(in_array($user->id, old('video_producer',$data['video_producer']))){ echo 'selected'; } ?> >{{$user->display_name}}
              </option>
            @endforeach
            </select>
        </div>
        <div class="form-group">
          <label for="onscreen">Who's Onscreen? (individuals and/or organizations)
          </label>
          {{--
          ...
          <select class="form-control multi-select2-with-tags" id="onscreen" multiple searchable="Search here.." name="onscreen[]">
            @foreach($user_list as $user)
            <option value="{{base64_encode($user->id)}}" 
                    <?php if(in_array($user->id, old('onscreen',$data['onscreen']))){ echo 'selected'; } ?> >{{$user->display_name}}
            </option>
          @endforeach
          </select>
      </div>
      <div class="form-group">
        <label for="co_creators">Co-Creator(s) (music credits, co-producers, etc.)
        </label>
        {{--
        ...
        <select class="form-control multi-select2-with-tags" multiple id="co_creators" searchable="Search here.." name="co_creators[]">
          @foreach($user_list as $user)
          <option value="{{base64_encode($user->id)}}" 
                  <?php if(in_array($user->id, old('co_creators',$data['co_creators']))){ echo 'selected'; } ?> >{{$user->display_name}}
          </option>
        @endforeach
        </select>
    </div>
    <div class="form-group">
      <label for="groups">Community, Group, or Organization(s) Involved
      </label>
      <select class="form-control multi-select2-with-tags" id="groups" multiple searchable="Search here.." name="groups[]">
        @foreach($groups as $group)
        <option value="{{base64_encode($group->id)}}" 
                <?php if(in_array($group->id, old('groups',$data['groups']))){ echo 'selected'; } ?> >{{$group->name}} ({{$group->email}})
        </option>
      @endforeach
      </select>
    {{--
  ...
  <div class="form-group">
    <label for="learn_more_url">URL (web address) to learn more about the contents of this video: 
    </label>
  ...
  <div class="btn_outer">
    ...
    <button type="button" onclick="submit_content()" class="btn dark">Submit PRCPTION
    </button>
  </div>
  <!-- btns -->
</div>
<div class="step hidden" id="st4">
  ...
  <div class="text_top">
    ...
    <h4>Visibility, Sorting, and Filters
    </h4>
    <p>Who and how should people find this PRCPTION?
    </p>
  </div>
  <div class="form-group">
    <label for="exampleSelect1">Privacy Settings: Who can find this PRCPTION?
    </label>
    <div class="custom_select">
...
<div class="form-group">
  <label for="category_id">Umbrella Category
  </label>
  <div class="custom_select">
    <select class="form-control" id="category_id" name="category_id">
      ...
      <option value="{{$cat->id}}" 
              <?php if($cat->id == old('category_id',$data['category_id'])){ echo 'selected'; } ?> >{{$cat->name}}
      </option>
    @endforeach
    </select>
</div>
...
<div class="form-group">
  <label for="exampleSelect1">Greater Community Intention
  </label>
...
<div class="form-group">
  <label for="primary_subject_tag">What's the Primary Subject of the PRCPTION?
  </label>
...
<div class="form-group">
  <label for="sorting_tags">Sorting Tags (like hashtags!)
  </label>
  <select class="form-control multi-select2-with-tags" id="sorting_tags" multiple name="sorting_tags[]">
    @foreach($sorting_tags as $tag)
    <option value="{{base64_encode($tag['id'])}}" 
            <?php if(in_array($tag->id, old('sorting_tags',$data['sorting_tags']))){ echo 'selected'; } ?> >{{$tag['tag']}}
    </option>
  @endforeach
  </select>
</div>
<div class="form-group">
  ...
  <select class="form-control" id="language" name="language">
    ...
    <option value="{{$lng->code}}" 
            <?php if(old('language',$data['language']) == $lng->code){ echo 'selected'; } ?> >{{$lng->language}}
    </option>
  @endforeach
  </select>
</div>
<div class="form-group">
  <input class="form-control" type="checkbox" id="is_exchange" 
         <?php if(!empty(old('exchange',$data['exchange']))){ ?> checked
  <?php } ?> value="1" name="exchange"/>
  <label class="exc" for="is_exchange"> Is there some sort of exchange being offered in this PRCPTION? (work trade, volunteer, etc)
  </label>
</div>
<div class="form-group" id="exchange_enabled" 
     <?php if(empty(old('exchange',$data['exchange']))){ ?> style="visibility: hidden; padding:0 40px;"
<?php } ?> >
<span class="exchange">
  <label for="is_exchange">Is this exchange a service or an opportunity being offered?
  </label>
  <select class="form-control multi-select2" id="service_or_opportunity" name="service_or_opportunity">
    ...
    <option value="1" 
            <?php if(old('exchange',$data['exchange'])=='1' ){ echo 'selected' ; } ?> >Service
    </option>
  <option value="2" 
          <?php if(old('exchange',$data['exchange'])=='2' ){ echo 'selected' ; } ?> >Opportunity
  </option>
</select>
</span>
</div>
...
<div class="form-group">
  ...
  <div class="row">
    <div class="col-2">
      <input type="text" class="form-control" aria-describedby="nameHelp" id="lat_val" name="lat" placeholder="Lat" value="{{ old('lat',$data['lat']) }}">
    </div>
    <div class="col-2">
      <input type="text" class="form-control" aria-describedby="nameHelp" id="long_val" name="long" placeholder="Long" value="{{ old('long',$data['long']) }}">
    </div>
  </div>
</div>
<?php }else{?>
...
<div class="step hidden" id="st6">
  ...
  <div class="row">
    <div>
      <p>
        <b style="color:#4214c7;">Thank you for your submission! :)
        </b>
        <br />
        <br />
  ...
  <div class="btn_outer" style="text-align:center;">
    <a href="#" class="btn click" style="float:none; margin:0 auto;">Start another Submission
    </a>
    <!-- submit button //hidden for DEMO ONLY -->
    <button type="button" onclick="submit_content()" class="btn dark" rel="st4" style="display:none;">Finish
    </button>
  </div>
  <!-- btns -->
</div>
  ...
  <div class="modal-dialog" style="position: relative;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h2 class="two">Introduce yourself as a relatable human being to the world.
        </h2>
        <p>
          <b>Goal: approx. 1 minute
          </b>
        </p>
        <p>
          <b>REQUIRED:
          </b> 40-60 seconds introductory audio/video.
          Introduce yourself, or the organization, or both.
          Where is the subject of your video/story located?
          Mention the date and the era of what's going on.
        </p>
        <p class="nomargin">
          <b>You may also include related photos and videos (audio will be cut).
          </b>
        </p>
      </div>
      <div class="youtube">
        <iframe width="100%" height="260px" src="https://www.youtube.com/embed/jNF9IamqLmA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
      </div>
      <div class="text">
        <p>
  ...
  <div class="modal-dialog" style="position: relative;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h2 class="two">Present information to the world via your perspective.
        </h2>
        <p>
          <b>Goal: 1 minute 30 seconds
          </b>
        </p>
        <p style="margin-bottom:0;">
          <b>REQUIRED:
          </b> 60-90 seconds of information-packed content, including vocal explanations and visuals of "what's up."
          What would you like to share? Explain, describe, present, or sell it to us. It can be anything!
          <br /> 
          <br />
          <b>Some examples:
          </b>
        ...
        <p class="bullets">
          ...
          </i> your words, an opinion or testimony 
          <br />
          <i class="fas fa-bullseye">
          </i> an activity or event
          <br />
          <i class="fas fa-bullseye">
          </i> a cause or mission that you support
        </p>
        <p class="nomargin">
          <b>Please include several photos and/or video clips of "what's up."
          </b>
        </p>
      </div>
      <div class="youtube">
  ...
  <div class="modal-dialog" style="position: relative;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h2 class="two">Engage the world with your passion!
        </h2>
        <p>
          <b>Goal: 1 minute
          </b>
        ...
        <p style="margin-bottom:0;">
          <b>REQUIRED: A conclusion and call-to-action of some sort.
          </b>
          <br />
          <br />
        ...
        <p class="nomargin">
          <b>Once again, you are free to include more photos and videos to help tell your story.
          </b>
        </p>
      </div>
      <div class="youtube">
