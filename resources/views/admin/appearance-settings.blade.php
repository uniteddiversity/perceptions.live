                        ...
                        <form action="/user/admin/setting/appearance" method="post" id="submit_content" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="nameHelp" name="default_location" placeholder="New York, USA" value="">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Default zoom</label>
                                    <input type="text" class="form-control" aria-describedby="nameHelp" name="default_zoom" placeholder="New York, USA" value="5">
                                </div>
