            ...
            <?php if ($data['id']) { ?>
              <div class="form-group">
                ...
                <p style="background-color: #cccccc;color: black;">
                  <textarea id="shearable_code" class="form-control">&lt;iframe src="<?php echo env('APP_DOMAIN', $_SERVER['SERVER_NAME']) ?>/home/shared/group/<?php echo $data['_token'] ?>?output=embed" width="100%" height="600" &gt; &lt;/iframe&gt;</textarea>
              ...
              <div class="form-group">
                ...
                <iframe src="<?php echo env('APP_DOMAIN', $_SERVER['SERVER_NAME']) ?>/home/shared/group/<?php echo $data['_token'] ?>?output=embed" width="100%" height="600"></iframe>
              </div>
            <?php } ?>
          </form>
      </div>
